    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100">
            ...
            <div className="container mx-auto px-4 py-8 max-w-4xl">
                ...
                {step === 2 && (
                    <div>
                        <h2 className="text-2xl font-bold mb-6">Choose Your Specialist</h2>
                                ...
                                <div className="flex items-start justify-between mb-4">
                                    <div>
                                        ...
                                        <p className="text-xl text-gray-600">
                                            {nextAvailableSlot.slot.startTime} - {nextAvailableSlot.slot.endTime}
                                        </p>
                                                ...
                                                {timeSlots
                                                    ...
                                                    .map((slot, index) => (
                                                        <button
                                                            ...
                                                            className="px-4 py-3 border-2 rounded-lg hover:opacity-90 transition-colors"
                                                            style={{
