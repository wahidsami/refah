...
function ProductPaymentContent() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const response = await api.post<{ success: boolean; transaction: any; order: any }>("/payments/process", {
                        ...
                        <div className="flex gap-4 pt-4">
                            ...
                            >
                                {loading ? (locale === 'ar' ? 'جاري المعالجة...' : 'Processing...') : (
                                    <>
                                        {locale === 'ar' ? 'دفع' : 'Pay'} <Currency amount={orderData.amount} locale={locale} />
                                    </>
                                )}
                            </button>
                            <button
                    ...
                    <div className="bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 animate-scale-in">
                        <div className="text-center">
                            ...
                            <p className="text-gray-600 mb-6">
                                {locale === 'ar' 
                                    ? 'تم تأكيد طلبك ومعالجة الدفع بنجاح. ستصلك رسالة تأكيد عبر البريد الإلكتروني قريباً.'
                                    : 'Your order has been confirmed and payment has been processed successfully. You will receive a confirmation email shortly.'
                                }
                            </p>
                            ...
                            <div className="flex flex-col sm:flex-row gap-3">
                                ...
                                >
                                    {locale === 'ar' ? 'عرض مشترياتي' : 'View My Purchases'}
                                </button>
                                <button
