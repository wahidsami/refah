...
const SECTIONS: { title: string; body: string }[] = [
    { title: 'aboutRefahWhatIs', body: 'aboutRefahWhatIsBody' },
    { title: 'aboutRefahWhatYouCanDo', body: 'aboutRefahWhatYouCanDoBody' },
    { title: 'aboutRefahForBusinesses', body: 'aboutRefahForBusinessesBody' },
    { title: 'aboutRefahContact', body: 'aboutRefahContactBody' },
];

export function AboutRefahScreen() {
    ...
    return (
        <View style={styles.container}>
            <View style={[styles.header, isRTL && styles.headerRTL]}>
                ...
                <Text style={[styles.headerTitle, isRTL && styles.textRTL]}>{t('aboutRefahTitle')}</Text>
            </View>
