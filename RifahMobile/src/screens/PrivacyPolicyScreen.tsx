...
const SECTIONS: { title: 'privacyDataWeCollect' | 'privacyHowWeUse' | 'privacySharing' | 'privacySecurity' | 'privacyRetention' | 'privacyRights' | 'privacyContact'; body: 'privacyDataBody' | 'privacyHowBody' | 'privacySharingBody' | 'privacySecurityBody' | 'privacyRetentionBody' | 'privacyRightsBody' | 'privacyContactBody' }[] = [
    { title: 'privacyDataWeCollect', body: 'privacyDataBody' },
    { title: 'privacyHowWeUse', body: 'privacyHowBody' },
    { title: 'privacySharing', body: 'privacySharingBody' },
    { title: 'privacySecurity', body: 'privacySecurityBody' },
    { title: 'privacyRetention', body: 'privacyRetentionBody' },
    { title: 'privacyRights', body: 'privacyRightsBody' },
    { title: 'privacyContact', body: 'privacyContactBody' },
];
