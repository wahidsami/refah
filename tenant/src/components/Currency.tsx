/**
 * Currency Component for Saudi Riyal (SAR) - Tenant Dashboard
...
export function InlineCurrency({ amount, locale = 'ar-SA' }: { amount: number; locale?: string }) {
  ...
  return (
    <span className="currency-display" dir="ltr">
...
export function StyledCurrency({ 
  ...
  return (
    <span className={`currency-display ${containerClassName}`} dir="ltr">
